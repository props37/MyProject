...
@Composable
fun PermissionRequirementBottomSheetScreen(
    navigate: (PermissionRequirementScreenAction) -> Unit,
    viewModel: PermissionRequirementViewModel = hiltViewModel(),
) {
    ...
    ScreenContent(
        ...
        onGoToSettingsClicked = viewModel::onGoToSettingsClicked,
...
private fun ScreenContent(
    ...
    PermissionRequirementScreenBehavior(
    ...
    ZarinaBottomSheet {
        Column(
            ...
            ZarinaButton(
                ...
                Text(text = stringResource(R.string.to_settings).uppercase())
            }
...
private fun Preview() {
    ZarinaPreview {
        ScreenContent(
            title = remember { Text.Resource(R.string.grant_location_permission) },
            body = remember { Text.Resource(R.string.it_will_help_us_to_detect_your_location) },
            onCloseClicked = {},
