...
fun ProductSearchScreen(
    ...
    ScreenContent(
        ...
        onClearProductSearchHistoryClicked = viewModel::onClearProductSearchHistoryClicked,
...
private fun ScreenContent(
    ...
    searchSuggestionsState: SearchSuggestionsState,
    onClearProductSearchHistoryClicked: () -> Unit,
            ...
            when (mode) {
                SearchMode.SEARCH -> {
                    SearchSuggestions(
                        ...
                        onClearSearchHistoryClicked = onClearProductSearchHistoryClicked,
