...
import ru.livetyping.zarina.presentation.screen.checkout.postdelivery.CheckoutPostDeliveryViewModel.SideEffect
import ru.livetyping.zarina.presentation.theme.UiKitTheme

@Composable
fun CheckoutPostDeliveryScreen(
    navigate: (CheckoutPostDeliveryScreenAction) -> Unit,
    viewModel: CheckoutPostDeliveryViewModel = hiltViewModel(),
) {
...
private fun ScreenContent(
    ...
    CheckoutPostDeliveryScreenBehavior(
    ...
    Column(
        ...
        CheckoutComponents.TopBar(
            title = stringResource(R.string.post_delivery),
            step = step,
            stepCount = stepCount,
