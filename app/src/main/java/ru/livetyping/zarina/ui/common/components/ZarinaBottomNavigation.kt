...
import ru.livetyping.zarina.ui.common.behavior.navigationbar.LocalNavigationBarController
import ru.livetyping.zarina.ui.common.behavior.navigationbar.NavigationBarBehavior
...
import ru.livetyping.zarina.ui.navigation.old.destinations.Favorites
...
sealed class BottomNavigationTab(
    ...
    object Home : BottomNavigationTab(
        ...
        destination = ru.livetyping.zarina.ui.navigation.old.destinations.Home,
    )

    object Profile : BottomNavigationTab(
        icon = R.drawable.old_ic_person_36,
        title = R.string.profile,
        destination = ru.livetyping.zarina.ui.navigation.old.destinations.Profile,
    )

    object Cart : BottomNavigationTab(
        icon = R.drawable.old_ic_shopping_bag_36,
        title = R.string.cart,
        destination = ru.livetyping.zarina.ui.navigation.old.destinations.Cart,
    )
