...
internal fun ProductSubscriptionContent(
    ...
    Column(modifier = modifier.verticalScroll(rememberScrollState())) {
        ...
        ProductOrderCard(
            ...
            size = productOffer.sizeEn.value,
        ...
        Policies(
            areAccepted = state.arePoliciesAccepted,
            onAcceptedChanged = { onEvent(ProductSubscriptionEvent.PoliciesAcceptedChanged(it)) },
            isError = state.arePoliciesInvalid,
            modifier = Modifier.padding(horizontal = 16.dp),
        )
...
private fun PoliciesText(
    ...
    val personalDataUrl = stringResource(RCommon.string.res_zarina_privacy_policy_url)
