...
internal class SignInByEmailConfirmationViewModel @Inject constructor(
    ...
    fun onPhoneConfirmationEvent(event: ru.livetyping.zarina.feature.signin.ui.impl.signinbyemail.model.SignInByEmailConfirmationEvent) {
        when (event) {
            ru.livetyping.zarina.feature.signin.ui.impl.signinbyemail.model.SignInByEmailConfirmationEvent.BackClicked -> onBackClicked()
            ru.livetyping.zarina.feature.signin.ui.impl.signinbyemail.model.SignInByEmailConfirmationEvent.OtpEntered -> onOtpEntered()
            ru.livetyping.zarina.feature.signin.ui.impl.signinbyemail.model.SignInByEmailConfirmationEvent.RequestNewOtpClicked -> onRequestNewOtpClicked()
        }
    }
