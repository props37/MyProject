...
internal class PhoneChangeConfirmationViewModel @Inject constructor(
    ...
    fun onPhoneChangeConfirmationEvent(event: ru.livetyping.zarina.feature.profile.ui.impl.phonechangeconfirmation.model.PhoneChangeConfirmationEvent) {
        when (event) {
            ru.livetyping.zarina.feature.profile.ui.impl.phonechangeconfirmation.model.PhoneChangeConfirmationEvent.BackClicked -> onBackClicked()
            ru.livetyping.zarina.feature.profile.ui.impl.phonechangeconfirmation.model.PhoneChangeConfirmationEvent.OtpEntered -> onOtpEntered()
            ru.livetyping.zarina.feature.profile.ui.impl.phonechangeconfirmation.model.PhoneChangeConfirmationEvent.RequestNewOtpClicked -> requestNewOtp()
        }
    }
