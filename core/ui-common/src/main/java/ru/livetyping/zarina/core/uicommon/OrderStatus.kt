...
public val OrderStatus.nameResId: Int
    get() = when (this) {
        ...
        OrderStatus.PAID -> RCommon.string.res_order_status_paid
        ...
        OrderStatus.APPROVED_TO_REFUND -> RCommon.string.res_order_status_approved_to_refund
        OrderStatus.REFUNDED -> RCommon.string.res_order_status_refunded
        ...
        OrderStatus.UNKNOWN -> RCommon.string.res_empty_string
    }
