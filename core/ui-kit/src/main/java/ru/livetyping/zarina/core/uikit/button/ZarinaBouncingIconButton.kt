...
@Composable
public fun ZarinaBouncingIconButton(
    onClick: () -> Unit,
    ...
    pressedScale: Float = ZarinaBouncingIconButtonDefaults.PressedScale,
    ...
    val scaleAnimationSpec = remember {
        spring(
            ...
            visibilityThreshold = ZarinaBouncingIconButtonDefaults.VisibilityThreshold,
        )
    }
...
public object ZarinaBouncingIconButtonDefaults {
    public const val PressedScale: Float = 0.8f
    public const val VisibilityThreshold: Float = 0.01f
}
