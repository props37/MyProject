...
import ru.livetyping.zarina.core.domain.usecase.product.GetProductTotalLookFlowUseCase.Params
import ru.livetyping.zarina.core.usecase.FlowUseCase
import ru.livetyping.zarina.core.usecase.UseCaseLogger

internal class GetProductTotalLookFlowUseCaseImpl(
    private val productRepository: ProductRepository,
    logger: UseCaseLogger?,
) : FlowUseCase<Params, List<ProductShort>>(logger), GetProductTotalLookFlowUseCase {

    override fun execute(params: Params): Flow<List<ProductShort>> {
        return productRepository.getProductTotalLookFlow(params.productId)
    }
