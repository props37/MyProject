    ...
    data class BasicItemDto(
        ...
        fun toMaterialFilterItem(): ProductMaterialFilterItem? {
            ...
            return if (id != null && name != null && isApplied != null) {
                ...
                Timber.tag(TAG).e("Ignore $this because it can't be mapped to ProductMaterialFilterItem")
                null
            }
        }
        ...
        fun toSizeFilterItem(): ProductSizeFilterItem? {
            ...
            return if (id != null && name != null && isApplied != null) {
                ...
                Timber.tag(TAG).e("Ignore $this because it can't be mapped to ProductSizeFilterItem")
                null
            }
        }
    }
    ...
    data class ColorItemDto(
        ...
        fun toColorFilterItem(): ProductColorFilterItem? {
            ...
            return if (id != null && name != null && code != null && isApplied != null) {
                ...
                Timber.tag(TAG).e("Ignore $this because it can't be mapped to ProductColorFilterItem")
                null
            }
        }
    }
    ...
    data class StoreDto(
        ...
        fun toPickupStoreFilterItem(): ProductPickupStoreFilterItem? {
            ...
            return if (id != null && name != null) {
                ...
                Timber.tag(TAG).e("Ignore $this because it can't be mapped to ProductPickupStoreFilterItem")
                null
            }
        }
    }
