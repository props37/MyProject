...
internal class RequestPasswordResetApiExceptionConverter @Inject constructor(
    @NetworkJson
    ...
    private fun handleJsonObject(element: JsonObject, originalException: Exception): Nothing {
        ...
        if (message is JsonPrimitive && message.content == MESSAGE_USER_NOT_FOUND) {
    ...
    companion object {
        private const val MESSAGE_USER_NOT_FOUND = "Пользователь с таким Email не найден"
    }
}
